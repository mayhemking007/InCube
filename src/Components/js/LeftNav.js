...
const onLogoutClick=()=>{
    ...
    return (
        <div className='leftnav'>
            <p className='leftnav-heading'>InCube</p>
            ...
            <div className='leftnav-option'>
                <img src={resources} />
                <p className='option-des' onClick={()=>{Navigate("/home")}} >My ideas</p>
            </div>
            <div className='leftnav-option'>
                <img src={aboutus} />
                <p className='option-des' onClick={()=>{Navigate("/createIdea")}} >Create a new idea</p>
            </div>
            <div className='leftnav-option'>
                <img src={contactus} />
