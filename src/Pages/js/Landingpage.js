...
import Heroimg from "../../assets/websiteimages/herotemp.svg";
...
function Landingpage() {
  ...
  return (
    <div>
      <div className="nav">
        ...
        <div className="nav-right">
          <a href="#Loginn" className="btn-login">
            Login
          </a>
          <a href="#Signupp" className="btn-signup">
            Signup
          </a>
      ...
      <div className="hero">
        <div className="hero-info">
          <p className="hero-heading">
           Delivering future, one idea at a time.
          </p>
          <p className="hero-subheading">
           Enable yourself to work on your ideas, seek mentorship and keep track of your progress.
          </p>
          <a href="#Signupp" className="btn">
            Signup
          </a>
        </div>
       ...
       <div className="steps">
        <p className="steps-miniheading">The InCube Process</p>
        <p className="steps-heading">Steps to use InCube</p>
        <div className="steps-container">
          <div className="step">
            ...
            <div className="step-info">
              ...
              <p className="step-des">
                To use InCube you first have to sign up or login ( if you already
                have an account).
              </p>
            </div>
          </div>
          <div className="step">
            <div className="step-info">
              ...
              <p className="step-des">
                You have to create your profile, which will contain your
          ...
          <div className="step">
            <img src={joinevents} />
            <div className="step-info">
              <p className="step-heading">Create a new Idea</p>
              <p className="step-des">
                Fill out the form and create a new idea by providing all the necessary information.
                Use the information provided, to benefit yourself from government schemes.
                Your idea will be forwarded to the incubator for the review.{" "}
              </p>
            </div>
          </div>
          <div className="step">
            <div className="step-info">
              <p className="step-heading">Tracking Progress</p>
              <p className="step-des">
                {" "}
                Keep track of your idea and stay in touch with your assign mentor for constant growth and 
                bidge the gap between idea and reality.
              </p>
            </div>
    ...
    <p className="auth-heading">{!login ?"Create your account" :"Login into your account"}</p>
        ...
        {!login ? 
              <div id = "Signupp" className="auth-entries">
     ...
     <div className="signup auth-inputs " >
       <input onFocus={onFormFocus} value={email} onChange={(e)=>{setEmail(e.target.value)}} type="text" placeholder="e.g - name@123.com" className="auth-input" />
       <input onFocus={onFormFocus} value={name}  onChange={(e)=>{setName(e.target.value)}} type="text" placeholder="e.g - Rohan agarwal" className="auth-input" />
       <input onFocus={onFormFocus} value={password} onChange={(e)=>{setPassword(e.target.value)}} type="password" placeholder="********" className="auth-input" />
